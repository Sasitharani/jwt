...
app.post('/login', (req, res) => {
    ...
    db.query(query, [username, username], (err, results) => {
        ...
        const hashedPasswordl = bcrypt.hashSync(password, 8);
        console.log('hashedPassword while login is:', hashedPasswordl);

        const passwordIsValid = bcrypt.compareSync(hashedPasswordl, user.password);
